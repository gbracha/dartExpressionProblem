...
import 'multiplicationEvaluator.dart' show MultiplicationWithEval;
...
void main() {
  Expression e = new Multiplication<Expression>(new Addition<Expression>(new Number(4), new Number(2)), 
                                    new Subtraction<Expression>(new Number(10), new Number(7))
                    );
  print('$e = ${e.eval}');
}
